...
import { checkIfVisitorUserExist, sendRecoveryLinkForVisitorUser } from '../../services/userCalls';
...
const ResetPassword: React.FC<ResetPasswordProps> = ({navigation}) => {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      {step === 1 ? (
        ...
        <>
          ...
          <TextInput
            ...
            placeholder={t('pages.ResetPasswordScreen.username') as string}
            style={styles.input}
          />
      ...
      <Button
        title={step === 1 ? t('pages.ResetPasswordScreen.continue') as string :
