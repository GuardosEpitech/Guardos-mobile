      ...
      <View style={[styles.container, darkMode && styles.containerDarkTheme]}>
        <View>
          <View style={styles.textContainer}>
            ...
            <Text style={[styles.title, darkMode && styles.titleDarkTheme]}>{t('pages.T&C.add')}</Text>
            <View style={[styles.line, darkMode && styles.lineDarkTheme]} />
            <View style={[styles.text, darkMode && styles.textDarkTheme]}>
              <Text style={[styles.text, darkMode && styles.textDarkTheme]}>{t('pages.T&C.addTxt')}</Text>
              <View style={styles.indentedList}>
                <Text>
                  <Text  style={[styles.text, darkMode && styles.textDarkTheme]}> {t('pages.T&C.details')} </Text>
                </Text>
                <Text>
                  <Text  style={[styles.text, darkMode && styles.textDarkTheme]}> {t('pages.T&C.dishes')} </Text>
                </Text>
                <Text>
                  <Text  style={[styles.text, darkMode && styles.textDarkTheme]}>{t('pages.T&C.allergens')} </Text>
                </Text>
              </View>
            </View>
