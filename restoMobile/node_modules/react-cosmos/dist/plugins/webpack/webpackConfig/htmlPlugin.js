...
function ensureHtmlWebackPlugin(_ref, plugins) {
  ...
  if ((0, _plugins.hasPlugin)(plugins, 'HtmlWebpackPlugin')) {
...
function isHtmlWebpackPlugin(plugin) {
  return (0, _plugins.isInstanceOfWebpackPlugin)(plugin, 'HtmlWebpackPlugin');
}

function changeHtmlPluginFilename(htmlPlugin) {
  if (!isIndexHtmlWebpackPlugin(htmlPlugin)) return htmlPlugin;
  var options = htmlPlugin.userOptions || htmlPlugin.options;
  var safeOptions = (0, _lodash.omit)(options, 'chunks');
...
function isIndexHtmlWebpackPlugin(htmlPlugin) {
  var _ref2 = htmlPlugin.userOptions || htmlPlugin.options,
